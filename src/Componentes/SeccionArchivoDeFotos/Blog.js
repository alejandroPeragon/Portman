...
function SeccionBlog(){
    return (
        <section className='row'>            
            <div className="col-lg-12" id='blog' data-aos='zoom-in-up'>
            ...
            <section className="row centrarBlog" data-aos="zoom-in">
                <div className="col-lg-5 text-center">
                    <img src={fotoArmada} alt="Imagen" className='img-fluid' width="400px" height="200px"></img>
                ...
                <div className="col-lg-5 text-center">
                    <img src={laChapa} alt="Imagen" className='img-fluid' width="400px" height="200px"></img>
                ...
                <div className="col-lg-5 text-center">
                    <img src={fotoVertidos} alt="Imagen" className='img-fluid' width="400px" height="200px"></img>
                ...
                <div className="col-lg-5 text-center">
                    <img src={huertaPaturro} alt="Imagen" className='img-fluid' width="400px" height="200px"></img>
